...
<link href="./PDFViewer/viewer.css" type="text/css"
	rel="stylesheet" />
...
<script type="text/JavaScript" src="./PDFViewer/l10n.js"></script>
<script type="text/JavaScript" src="./PDFViewer/pdf.js"></script>
<script type="text/JavaScript" src="./PDFViewer/debugger.js"></script>
<script type="text/JavaScript" src="./PDFViewer/viewer.js"></script>
...
<script>
	var maxtopHeight = parseInt(top.winHeight * 90 / 100) - 32;
	var maxtopWidth = parseInt(top.winWidth * 90 / 100) - 252;
	//$("#mainContainer").height(maxtopHeight);
	//setDialogScrollBar("mainContainer",maxtopHeight+20);
	var DEFAULT_URL = "";
	showFlax();
	function showFlax() {
		$("#outerContainer").show();
